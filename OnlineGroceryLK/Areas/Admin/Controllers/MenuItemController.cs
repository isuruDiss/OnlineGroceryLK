...
namespace Spice.Areas.Admin.Controllers
{
    ...
    public class MenuItemController : Controller
    {
        ...
        {
            var menuItems = await _db.MenuItem.Include(m=>m.Category).ToListAsync();
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            MenuItemVM.MenuItem = await _db.MenuItem.Include(m => m.Category).SingleOrDefaultAsync(m => m.Id == id);
        ...
        public async Task<IActionResult> EditPOST(int? id)
        {
            ...
            //if (!ModelState.IsValid)
            //{
            //    MenuItemVM.c = await _db.SubCategory.Where(s => s.CategoryId == MenuItemVM.MenuItem.CategoryId).ToListAsync();
            //    return View(MenuItemVM);
            //}
