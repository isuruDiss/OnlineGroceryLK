...
namespace OnlineGroceryLK.Data.Migrations
{
    ...
    [Migration("20210318071306_addProductIdtoSopping")]
    partial class addProductIdtoSopping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.StockMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.OrderDetails", b =>
                {
                    b.HasOne("OnlineGroceryLK.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineGroceryLK.Models.StockMaster", "StockMaster")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.OrderHeader", b =>
                {
                    b.HasOne("OnlineGroceryLK.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OnlineGroceryLK.Models.StockMaster", b =>
                {
                    ...
                    b.HasOne("OnlineGroceryLK.Models.Product", "Product")
                        .WithMany()
